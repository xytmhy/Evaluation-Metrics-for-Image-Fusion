...
fuseX=imfilter(flt1,fuse,'same');
fuseY=imfilter(flt2,fuse,'same');
...
img1X=imfilter(flt1,img1,'same');
img1Y=imfilter(flt2,img1,'same');
...
img2X=imfilter(flt1,img2,'same');
img2Y=imfilter(flt2,img2,'same');
